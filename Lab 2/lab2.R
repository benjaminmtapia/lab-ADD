...
data1<-dplyr::filter(data,classname != '2-4-d-injury', classname!= 'herbicide-injury',
                     classname != 'cyst-nematode', classname != 'diaporthe-pod-&-stem-blight')
data1[13:19]<- NULL

data1<- na.omit(data1)
cluster <- pam(data1, k=2)
plot(cluster)